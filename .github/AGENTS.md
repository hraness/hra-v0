...
- `workflows/` – archive policy and documentation verification for pull requests, `main`, and manual runs.
...
- Do not use repository secrets, `pull_request_target`, production signing custody, release publication, provider mutation, or artifact upload.
