...
- `web/` – the archived HRA v0 Next.js task control plane and historical Convex and Vercel integration source.
...
- No child is connected to a hosted provider. `web/` preserves retired Vercel and Convex configuration as historical source only.
