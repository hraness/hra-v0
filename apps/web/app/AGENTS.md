...
- Keep `/.well-known/hra.json` stable and public. Bind generation 0 to the checked numeric GitHub repository ID and frozen v0.1.14 publication. Do not derive it from the staged download contract, mutable request state, or provider state. A later ledger and surface-authority update is a separate review.
