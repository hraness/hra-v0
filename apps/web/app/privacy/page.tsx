      ...
      <main className="alternatives-shell" id="main-content">
        ...
        <section aria-labelledby="security-title" className="alternatives-section privacy-section">
          ...
          <div className="privacy-copy">
            ...
            <p>
              HRA v0 is archived. Its generation-2 compatibility ledger ends at the immutable v0.1.16 prerelease. A material correction to this notice will update its date and the checked public source. Privacy information for the current HRA belongs at <a href={CURRENT_HRA_SITE}>hra.sh</a>.
            </p>
          </div>
        </section>
      </main>
