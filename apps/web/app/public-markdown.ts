...
export function createHraLlmsTxt(): string {
  ...
  return [
    ...
    "",
    `This is the maintained archive for HRA v0. New users should start with [current HRA](${CURRENT_HRA_SITE}) and its [current source](${CURRENT_HRA_REPOSITORY}). Use this site for HRA v0 macOS release status, the frozen v0.1.7–v0.1.16 compatibility ledger, historical source, and v0 documentation.`,
    "",
...
export function createReleaseHistoryMarkdown(): string {
  ...
  return [
    ...
    "",
    "This generation-2 compatibility ledger records every HRA v0 tag from v0.1.7 through v0.1.16, every GitHub release that exists, and all 63 attached assets. v0.1.16 is the final archived prerelease.",
    "",
    ...entries,
    "## Public pages",
    "",
...
export function createPrivacyMarkdown(): string {
  return [
    ...
    "",
    `HRA v0 is archived. Its generation-2 compatibility ledger ends at the immutable v0.1.16 prerelease. Privacy information for the current HRA belongs at ${CURRENT_HRA_SITE}.`,
    "",
    "## Public pages",
    "",
    `- [HRA v0 archive](${absoluteUrl("/")})`,
